...
unsigned int nStakeMinAge = 60 * 60 * 7;	// minimum age for coin age: 7 hours
unsigned int nStakeMaxAge = 60 * 60 * 24 * 30;	// stake age of full weight: 30ddays
...
const string strMessageMagic = "Molly Signed Message:\n";
...
static const int64 nTargetTimespan = 30 * 60; // 30 blocks
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in Molly
    bool fStrictPayToScriptHash = true; // Always active in Molly
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Molly", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "March 14, 2015, Molly Baby! .";
        CTransaction txNew;
        ...
        block.nVersion = 1;
        block.nTime    = 1417308818;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1424737;
        ...
        assert(block.hashMerkleRoot == uint256("0x3993fa002f205d6662624f2d67f3fdc8168624c33dad59dd27e3504f5cf39a98"));
